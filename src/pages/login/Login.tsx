        ...
        <>
            <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen place-items-center font-bold">
                ...
                >
                    ...
                    <button
                        type="submit"
                        className="rounded bg-slate-400 hover:bg-slate-800 flex justify-center text-white w-full sm:w-2/3 py-2"
                        disabled={isLoading}
                    >
                ...
                <div
                    className="bg-[url('https://i.imgur.com/2jDMgHn.jpg')] lg:block hidden bg-no-repeat w-full min-h-screen bg-cover bg-center"
                ></div>
            </div>
        </>
    );
